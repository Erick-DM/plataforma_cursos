...
const courseSeed = [
  ...
  },
  {
    ...
    level: 'Básico',
    modules: [
      { title: 'Docker como base', summary: 'Docker estandariza la forma de construir, ejecutar y publicar aplicaciones.', outcome: 'Comprenderás por qué Docker se convirtió en un estándar de operación.', highlights: ['Unifica el flujo de trabajo', 'Acelera el despliegue', 'Reduce diferencias entre equipos'], videoUrl: 'https://www.youtube.com/watch?v=3c-iBn73dDE' },
      { title: 'AWS', summary: 'AWS ofrece servicios de cómputo, red, base de datos y monitoreo para sistemas modernos.', outcome: 'Reconocerás cómo la nube ofrece recursos gestionables y escalables.', highlights: ['Amplía capacidad de infraestructura', 'Agiliza administración de servicios', 'Integra herramientas de monitoreo'], videoUrl: 'https://www.youtube.com/watch?v=2vVb2vuKk2k' },
      { title: 'Azure', summary: 'Azure ofrece herramientas para administrar entornos cloud con integración empresarial.', outcome: 'Entenderás el valor de integrar servicios de Microsoft en entornos productivos.', highlights: ['Optimiza operaciones híbridas', 'Organiza identidades y accesos', 'Facilita administración centralizada'], videoUrl: 'https://www.youtube.com/watch?v=p2sgw5VJx0w' },
      { title: 'Google Cloud', summary: 'Google Cloud proporciona infraestructura escalable para aplicaciones web y APIs.', outcome: 'Conocerás las opciones de infraestructura y servicios inteligentes en la nube.', highlights: ['Apoya cargas de trabajo modernas', 'Ofrece servicios de inteligencia', 'Escala con facilidad'], videoUrl: 'https://www.youtube.com/watch?v=0qotVMX2Khk' },
      { title: 'Comparación entre plataformas', summary: 'Cada proveedor ofrece ventajas diferenciales según el tipo de carga y la arquitectura.', outcome: 'Serás capaz de elegir una plataforma según costos, requerimientos y equipo.', highlights: ['Compara ventajas y límites', 'Evalúa facilidad de operacion', 'Ajusta decisiones técnicas'], videoUrl: 'https://www.youtube.com/watch?v=8fiXow4s8yU' },
      { title: 'Gestión de recursos', summary: 'La gestión de recursos permite controlar costos, capacidad y rendimiento.', outcome: 'Aprenderás a monitorear y ajustar recursos de forma responsable.', highlights: ['Optimiza gastos', 'Ajusta capacidad a demanda', 'Mejora estabilidad'], videoUrl: 'https://www.youtube.com/watch?v=0qotVMX2Khk' },
      { title: 'Seguridad cloud', summary: 'La seguridad en la nube integra cifrado, políticas y control de accesos.', outcome: 'Comprenderás que la seguridad debe formar parte del diseño desde el inicio.', highlights: ['Protege datos sensibles', 'Controla permisos', 'Reduce riesgos de compromisos'], videoUrl: 'https://www.youtube.com/watch?v=_dfLOzuIg2o' },
      { title: 'Escalabilidad', summary: 'La escalabilidad permite responder a cambios de demanda con mayor eficiencia.', outcome: 'Reconocerás cómo preparar sistemas para crecer sin degradar rendimiento.', highlights: ['Responde a picos de tráfico', 'Asegura continuidad', 'Ajusta capacidad en tiempo real'], videoUrl: 'https://www.youtube.com/watch?v=3c-iBn73dDE' },
      { title: 'Automatización', summary: 'Los pipelines y scripts reducen errores y aceleran el despliegue.', outcome: 'Aplicarás automatización para tener procesos más predecibles.', highlights: ['Reduce intervención manual', 'Disminuye errores', 'Acelera frecuencia de publicación'], videoUrl: 'https://www.youtube.com/watch?v=2vVb2vuKk2k' },
      { title: 'Buenas prácticas de operación', summary: 'Un despliegue bien administrado combina monitoreo, control y documentación.', outcome: 'Dominarás cómo mantener entornos estables y operables.', highlights: ['Documenta procesos', 'Monitorea continuamente', 'Previene incidentes'], videoUrl: 'https://www.youtube.com/watch?v=p2sgw5VJx0w' }
    ]
  },
  {
    ...
    level: 'Intermedio',
    modules: [
      { title: 'Servidor de aplicaciones', summary: 'Un servidor de aplicaciones ejecuta la lógica de negocio y expone servicios.', outcome: 'Comprenderás cómo separar la capa de negocio del acceso de los usuarios.', highlights: ['Gestiona reglas del negocio', 'Expone endpoints funcionales', 'Facilita escalado horizontal'], videoUrl: 'https://www.youtube.com/watch?v=2vVb2vuKk2k' },
      { title: 'Servidor de base de datos', summary: 'La base de datos centraliza información y administra accesos concurrentes.', outcome: 'Conocerás la importancia de estructurar datos de forma segura y eficiente.', highlights: ['Organiza información crítica', 'Optimiza consultas', 'Soporta concurrencia'], videoUrl: 'https://www.youtube.com/watch?v=3c-iBn73dDE' },
      { title: 'Balanceo de cargas', summary: 'El balanceador de cargas distribuye tráfico para mejorar rendimiento y continuidad.', outcome: 'Aprenderás a evitar cuellos de botella en servicios críticos.', highlights: ['Distribuye peticiones', 'Mejora disponibilidad', 'Equilibra recursos'], videoUrl: 'https://www.youtube.com/watch?v=0qotVMX2Khk' },
      { title: 'Alta disponibilidad', summary: 'La redundancia evita interrupciones durante fallos parciales del sistema.', outcome: 'Reconocerás cómo diseñar sistemas resilientes para operaciones reales.', highlights: ['Reduce tiempos de caída', 'Protege la continuidad', 'Asegura servicio estable'], videoUrl: 'https://www.youtube.com/watch?v=8fiXow4s8yU' },
      { title: 'Monitoreo', summary: 'Las métricas permiten detectar fallas antes de que afecten a los usuarios.', outcome: 'Identificarás los indicadores clave para mantener el sistema sano.', highlights: ['Detecta anomalías pronto', 'Mejora respuesta ante incidentes', 'Aumenta confianza operativa'], videoUrl: 'https://www.youtube.com/watch?v=_dfLOzuIg2o' },
      { title: 'Almacenamiento', summary: 'Los servicios de almacenamiento permiten persistir datos y archivos.', outcome: 'Entenderás cómo elegir el tipo de almacenamiento según el caso.', highlights: ['Asegura persistencia', 'Facilita acceso compartido', 'Mejora capacidad de crecimiento'], videoUrl: 'https://www.youtube.com/watch?v=p2sgw5VJx0w' },
      { title: 'Seguridad de red', summary: 'Los grupos de seguridad y reglas de tráfico protegen los servicios expuestos.', outcome: 'Comprenderás cómo controlar el acceso a los recursos con reglas claras.', highlights: ['Protege recursos expuestos', 'Define políticas de entrada', 'Reduce superficies de ataque'], videoUrl: 'https://www.youtube.com/watch?v=3c-iBn73dDE' },
      { title: 'CDN', summary: 'Una red de distribución mejora la velocidad de entrega para usuarios globales.', outcome: 'Conocerás cómo ubicar contenido más cerca de los clientes.', highlights: ['Reduce latencia', 'Mejora desempeño global', 'Optimiza entrega de recursos'], videoUrl: 'https://www.youtube.com/watch?v=0qotVMX2Khk' },
      { title: 'Escalado automático', summary: 'El escalado automático ajusta recursos conforme cambia la demanda.', outcome: 'Entenderás cómo responder de forma dinámica a picos de tráfico.', highlights: ['Ajusta capacidad en tiempo real', 'Mejora eficiencia de costos', 'Mantiene experiencia estable'], videoUrl: 'https://www.youtube.com/watch?v=2vVb2vuKk2k' },
      { title: 'Respaldo y recuperación', summary: 'La recuperación ante desastres garantiza continuidad de negocio.', outcome: 'Aprenderás cómo planificar la continuidad en caso de pérdida o interrupción.', highlights: ['Protege información crítica', 'Recupera servicios con rapidez', 'Asegura continuidad'], videoUrl: 'https://www.youtube.com/watch?v=_dfLOzuIg2o' }
    ]
  },
  {
    slug: 'configuracion',
    ...
    level: 'Intermedio',
    modules: [
      { title: 'Configuración de dominio', summary: 'El dominio facilita que los usuarios accedan al sitio con un nombre reconocible.', outcome: 'Aprenderás a asociar servicios con una identidad digital clara.', highlights: ['Mejora accesibilidad', 'Aumenta confianza de marca', 'Simplifica navegación'], videoUrl: 'https://www.youtube.com/watch?v=3c-iBn73dDE' },
      { title: 'DNS', summary: 'El sistema DNS traduce nombres de dominio a direcciones de servidor.', outcome: 'Entenderás el rol central del DNS en la infraestructura web.', highlights: ['Convierte nombres a IP', 'Asegura conexión correcta', 'Soporta red distribuida'], videoUrl: 'https://www.youtube.com/watch?v=2vVb2vuKk2k' },
      { title: 'Certificados SSL', summary: 'Los certificados cifran el tráfico y validan la identidad del sitio.', outcome: 'Conocerás la importancia de HTTPS en entornos seguros.', highlights: ['Protege información en tránsito', 'Valida identidad', 'Aumenta confianza del usuario'], videoUrl: 'https://www.youtube.com/watch?v=p2sgw5VJx0w' },
      { title: 'HTTPS', summary: 'HTTPS protege la comunicación entre el navegador y el servidor.', outcome: 'Reconocerás la diferencia entre tráfico abierto y tráfico cifrado.', highlights: ['Evita interceptaciones', 'Mejora integridad de datos', 'Asegura transporte seguro'], videoUrl: 'https://www.youtube.com/watch?v=0qotVMX2Khk' },
      { title: 'Firewall', summary: 'Un firewall controla el tráfico de entrada y salida según reglas.', outcome: 'Aprenderás a filtrar accesos y minimizar amenazas.', highlights: ['Limita tráfico indeseado', 'Protege servicios expuestos', 'Organiza reglas de acceso'], videoUrl: 'https://www.youtube.com/watch?v=8fiXow4s8yU' },
      { title: 'Variables de entorno', summary: 'Las variables de entorno separan configuraciones sensibles del código.', outcome: 'Comprenderás cómo externalizar secretos y ajustes de entorno.', highlights: ['Reduce hardcoding', 'Mejora seguridad', 'Ajusta configuración por entorno'], videoUrl: 'https://www.youtube.com/watch?v=_dfLOzuIg2o' },
      { title: 'Secretos', summary: 'Los secretos deben almacenarse y rotarse de forma segura.', outcome: 'Aprenderás cómo proteger claves y credenciales críticas.', highlights: ['Evita exposición accidental', 'Mejora control de acceso', 'Asegura rotación de credenciales'], videoUrl: 'https://www.youtube.com/watch?v=3c-iBn73dDE' },
      { title: 'Logs y auditoría', summary: 'La auditoría permite rastrear cambios y resolver incidentes.', outcome: 'Conocerás cómo volver trazables las operaciones del sistema.', highlights: ['Registra eventos clave', 'Facilita diagnósticos', 'Soporta cumplimiento'], videoUrl: 'https://www.youtube.com/watch?v=p2sgw5VJx0w' },
      { title: 'Monitoreo de seguridad', summary: 'Los sistemas de monitoreo detectan accesos sospechosos y fallos operativos.', outcome: 'Identificarás cómo reaccionar más rápido ante amenazas.', highlights: ['Detecta actividad anómala', 'Aumenta visibilidad', 'Mejora tiempos de respuesta'], videoUrl: 'https://www.youtube.com/watch?v=0qotVMX2Khk' },
      { title: 'Buenas prácticas de despliegue', summary: 'Una infraestructura bien configurada reduce riesgos y mejora confiabilidad.', outcome: 'Aplicarás criterios de operación profesional en tus despliegues.', highlights: ['Reduce riesgos', 'Asegura estabilidad', 'Mejora continuidad'], videoUrl: 'https://www.youtube.com/watch?v=2vVb2vuKk2k' }
    ]
  },
  {
    slug: 'pruebas',
    ...
    level: 'Avanzado',
    modules: [
      { title: 'Caja blanca', summary: 'La caja blanca revisa la estructura interna y la lógica del software.', outcome: 'Comprenderás cómo validar el comportamiento del código desde dentro.', highlights: ['Revisa lógica interna', 'Detecta errores de implementación', 'Apoya refactorización'], videoUrl: 'https://www.youtube.com/watch?v=0qotVMX2Khk' },
      { title: 'Caja negra', summary: 'La caja negra evalúa comportamiento esperado desde el punto de vista del usuario.', outcome: 'Identificarás cómo probar funciones sin conocer el detalle interno.', highlights: ['Evalúa experiencia de usuario', 'Prueba comportamiento observable', 'Reduce sesgos técnicos'], videoUrl: 'https://www.youtube.com/watch?v=3c-iBn73dDE' },
      { title: 'Pruebas unitarias', summary: 'Las pruebas unitarias validan módulos aislados antes de integrarlos.', outcome: 'Aprenderás a encontrar fallos en piezas pequeñas desde el inicio.', highlights: ['Aísla componentes', 'Rápidas de ejecutar', 'Mejoran diseño'], videoUrl: 'https://www.youtube.com/watch?v=2vVb2vuKk2k' },
      { title: 'Pruebas de integración', summary: 'La integración verifica que los módulos trabajen correctamente juntos.', outcome: 'Comprenderás la importancia de validar flujos completos.', highlights: ['Prueba interacción entre piezas', 'Detecta fallos de interfaz', 'Mejora estabilidad'], videoUrl: 'https://www.youtube.com/watch?v=p2sgw5VJx0w' },
      { title: 'Pruebas de regresión', summary: 'Las regresiones aseguran que cambios recientes no rompan funciones ya existentes.', outcome: 'Conocerás cómo proteger funcionalidades validadas de cambios futuros.', highlights: ['Evita pérdidas inesperadas', 'Asegura continuidad', 'Protege entregas'], videoUrl: 'https://www.youtube.com/watch?v=8fiXow4s8yU' },
      { title: 'Pruebas de rendimiento', summary: 'El rendimiento mide velocidad, capacidad y estabilidad bajo carga.', outcome: 'Aprenderás a medir la calidad operativa del sistema.', highlights: ['Evalúa tiempos de respuesta', 'Detecta cuellos de botella', 'Mejora experiencia del usuario'], videoUrl: 'https://www.youtube.com/watch?v=_dfLOzuIg2o' },
      { title: 'Pruebas de esfuerzo', summary: 'Las pruebas de esfuerzo analizan el comportamiento en límites de capacidad.', outcome: 'Reconocerás cómo preparar sistemas para picos reales de uso.', highlights: ['Prueba límites del sistema', 'Evalúa estabilidad bajo presión', 'Previene fallas mayores'], videoUrl: 'https://www.youtube.com/watch?v=3c-iBn73dDE' },
      { title: 'Pruebas de usabilidad', summary: 'Las pruebas de usabilidad evalúan la experiencia del usuario final.', outcome: 'Identificarás cómo mejorar la interacción y la comprensión.', highlights: ['Evalúa claridad del flujo', 'Mejora satisfacción', 'Reduce fricción'], videoUrl: 'https://www.youtube.com/watch?v=0qotVMX2Khk' },
      { title: 'Automatización de pruebas', summary: 'La automatización acelera ejecuciones repetitivas y mejora cobertura.', outcome: 'Comprenderás cómo integrar pruebas en ciclos rápidos de entrega.', highlights: ['Aumenta cobertura', 'Disminuye tiempos manuales', 'Mejora repetibilidad'], videoUrl: 'https://www.youtube.com/watch?v=2vVb2vuKk2k' },
      { title: 'Métricas de calidad', summary: 'Los indicadores ayudan a priorizar mejoras y medir el avance del proyecto.', outcome: 'Aprenderás a transformar datos de prueba en decisiones concretas.', highlights: ['Cuantifica resultados', 'Aporta evidencia', 'Mejora priorización'], videoUrl: 'https://www.youtube.com/watch?v=p2sgw5VJx0w' }
    ]
  },
  {
    slug: 'liberacion',
    ...
    level: 'Avanzado',
    modules: [
      { title: 'Políticas de liberación', summary: 'Las políticas establecen criterios claros para publicar software con confianza.', outcome: 'Comprenderás cómo definir reglas de publicación y control de calidad.', highlights: ['Establece condiciones claras', 'Reduce riesgos', 'Guía decisiones de negocio'], videoUrl: 'https://www.youtube.com/watch?v=3c-iBn73dDE' },
      { title: 'Normativa aplicable', summary: 'La normativa guía el cumplimiento legal, de seguridad y trazabilidad.', outcome: 'Reconocerás la importancia del cumplimiento en cada liberación.', highlights: ['Alinea procesos con la ley', 'Mejora trazabilidad', 'Protege la organización'], videoUrl: 'https://www.youtube.com/watch?v=p2sgw5VJx0w' },
      { title: 'Control de versiones', summary: 'El control de versiones registra cambios y facilita la colaboración.', outcome: 'Aprenderás a administrar entregas con mayor control y visibilidad.', highlights: ['Registra evolución del producto', 'Facilita colaboración', 'Evita pérdidas de historial'], videoUrl: 'https://www.youtube.com/watch?v=2vVb2vuKk2k' },
      { title: 'Plan de despliegue', summary: 'El plan de despliegue organiza las tareas, riesgos y validaciones.', outcome: 'Conocerás cómo preparar una liberación de forma ordenada.', highlights: ['Coordina actividades', 'Reduce errores operativos', 'Mejora tiempos de salida'], videoUrl: 'https://www.youtube.com/watch?v=0qotVMX2Khk' },
      { title: 'Documentación técnica', summary: 'La documentación técnica mantiene el conocimiento del sistema disponible.', outcome: 'Comprenderás cómo preservar la memoria del proyecto para el equipo.', highlights: ['Guarda conocimiento', 'Facilita mantenimiento', 'Reduce dependencia individual'], videoUrl: 'https://www.youtube.com/watch?v=8fiXow4s8yU' },
      { title: 'Manual de usuario', summary: 'El manual orienta al usuario sobre uso correcto y buenas prácticas.', outcome: 'Aprenderás a acompañar la adopción con información útil y clara.', highlights: ['Mejora autogestión del usuario', 'Reduce soporte repetitivo', 'Aumenta satisfacción'], videoUrl: 'https://www.youtube.com/watch?v=_dfLOzuIg2o' },
      { title: 'Soporte y mantenimiento', summary: 'Mantenimiento y soporte garantizan continuidad después del lanzamiento.', outcome: 'Reconocerás el valor del soporte continuo en los productos.', highlights: ['Responde a incidentes', 'Mantiene estabilidad', 'Mejora confianza del cliente'], videoUrl: 'https://www.youtube.com/watch?v=2vVb2vuKk2k' },
      { title: 'Retroalimentación', summary: 'La retroalimentación de usuarios ayuda a mejorar futuras versiones.', outcome: 'Comprenderás cómo convertir comentarios en mejoras concretas.', highlights: ['Prioriza mejoras reales', 'Mejora producto', 'Aumenta valor percibido'], videoUrl: 'https://www.youtube.com/watch?v=p2sgw5VJx0w' },
      { title: 'Trazabilidad', summary: 'Trazar cambios facilita auditorías y resolución de incidentes.', outcome: 'Conocerás cómo mantener evidencias de cada decisión y cambio.', highlights: ['Aporta contexto del cambio', 'Acelera auditorías', 'Simplifica resolución de fallos'], videoUrl: 'https://www.youtube.com/watch?v=3c-iBn73dDE' },
      { title: 'Liberación final', summary: 'La liberación final combina validación, documentación y comunicación.', outcome: 'Aplicarás un enfoque completo para cerrar un proyecto con calidad.', highlights: ['Unifica validación y comunicación', 'Reduce riesgos finales', 'Mejora aceptación del producto'], videoUrl: 'https://www.youtube.com/watch?v=0qotVMX2Khk' }
    ]
  }
];
